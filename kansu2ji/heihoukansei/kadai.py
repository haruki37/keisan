...
# 途中式なし
        if a == 1:
            if b > 0:
                if C > 0:
                    totyu2 = "(x +" + str(b) + ")^2 -" + str(b**2) + "+" + str(C)
                elif C < 0:                                              
                    totyu2 = "(x +" + str(b) + ")^2 -" + str(b**2) +       str(C)
            else:                                                 
                if C > 0:                                       
...
# 途中式あり
            ...
            if a == -1:
                if b > 0:
                    if C == 0:
                        totyu1 = "-(x^2 +" + str(2*b) + "x)"
                    elif C > 0:
                        totyu1 = "-(x^2 +" + str(2*b) + "x) +" + str(C)
                        totyu2 = "-(x +" + str(b) + ")^2 +" + str(b**2) + "+" + str(C)
                    else:
                        totyu1 = "-(x^2 +" + str(2*b) + "x)"   + str(C)
                        totyu2 = "-(x +" + str(b) + ")^2 +" + str(b**2) +       str(C)
                ...
                if b > 0:
                    if C == 0:
                        totyu1 = str(a) + "(x^2 +" + str(2*b) + "x)"
                    elif C > 0:
                        totyu1 = str(a) + "(x^2 +" + str(2*b) + "x) +" + str(C)
                        totyu2 = str(a) + "(x +" + str(b) + ")^2"   + str(-a*b**2) + "+" + str(C)
                    else:
                        totyu1 = str(a) + "(x^2 +" + str(2*b) + "x)"   + str(C)
                        totyu2 = str(a) + "(x +" + str(b) + ")^2"   + str(-a*b**2) +       str(C)
                else:
