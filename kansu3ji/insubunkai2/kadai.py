...
with open("ensyu.tex","w") as f:
    ...
    print(r"tip1: $"+sy.latex(ans1)+"$\n", file = f)
    print(r"~~~~~~~~~$="+sy.latex(pra1)+"$", file = f)
    print("\n", file = f)
    print(r"tip2: $"+sy.latex(ans2)+"$\n", file = f)
    print(r"~~~~~~~~~$="+sy.latex(pra2)+"$", file = f)
    print("\n", file = f)
# 解答のlatex
with open("ans.tex","w") as g:
    ...
    print(r"tip1: $"+sy.latex(ans1)+"$\n", file = g)
    print(r"~~~~~~~~~$="+sy.latex(pra1)+"$", file = g)
    print("\n", file = g)
    print(r"tip2: $"+sy.latex(ans2)+"$\n", file = g)
    print(r"~~~~~~~~~$="+sy.latex(pra2)+"$", file = g)
    print("\n", file = g)
# 問題の作成
i = 1
while i <= n:
